  ...
  "SIMD Execution Unit should execute sQNTI16I8S.vv.AQ instructions" in {
    test(new simd.SIMDEngine()).withAnnotations(Seq(
      ...
      for (i <- 0 until 10) {
        ...
        //print(rd_arr(3).toShort.toHexString.takeRight(2))
        //print(rd_arr(2).toShort.toHexString.takeRight(2))
        //print(rd_arr(1).toShort.toHexString.takeRight(2))
        //println(rd_arr(0).toShort.toHexString.takeRight(2))
        //println("==============================================")
        dut.clock.step(1)
      }
    }
