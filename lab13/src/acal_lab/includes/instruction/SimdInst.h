...
/**
 * @brief Relu
 * @note `inline void sQNTI16I8S_vv_AQ(int8_t c[4], int8_t a[4], int8_t not_used)`
 * @param arrI8c(rd) Output array to store the quantized INT8 values.
 * @param arrI8a(rs1) Input array[0:3] containing INT8 values to relu.
 */
#define sRELUI8S(arrI8c, arrI8a, I8b) \
	(*(int32_t*)(arrI8c) = cfu_op(0b000, 0b0001111, *(int32_t*)(arrI8a), (int32_t)(I8b)))

/**
 * @brief Maxpool
 * @note `inline void sQNTI16I8S_vv_AQ(int8_t c[4], int8_t a[4], int8_t not_used)`
 * @param arrI8c(rd) Output array to store the quantized INT8 values.
 * @param arrI8a(rs1) Input array[0:3] containing INT8 values to maxpool.
 */
#define sMAXPOOLI8S(arrI8c, arrI8a, I8b) \
	(*(int32_t*)(arrI8c) = cfu_op(0b001, 0b0001111, *(int32_t*)(arrI8a), (int32_t)(I8b)))
